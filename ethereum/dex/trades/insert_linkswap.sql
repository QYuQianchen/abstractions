CREATE OR REPLACE FUNCTION dex.insert_linkswap(start_ts timestamptz, end_ts timestamptz=now(), start_block numeric=0, end_block numeric=9e18) RETURNS integer
